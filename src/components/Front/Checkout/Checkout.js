...
const Checkout = () => {
  ...
  const PaymentsuccessProccess = () => {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var url =
        "https://pramesh.justcodenow.com/backend/api/paymentsuccessproccess";
    }
            ...
            <div className="leftcheck   col-xl-6 col-lg-8 mx-auto ">
              ...
              <div className="contactdetails">
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mt-3">
                    <select
                      onChange={(e) => setvChangeCountry(e.target.value)}
                      id="vCountry"
                      name="vCountry"
                      className="form-control"
                    >
                  ...
                  <div className="col-md-6 mt-3">
                    <select
                      id="vState"
                      onChange={(e) => setvChangeState(e.target.value)}
                      name="vState"
                      className="form-control"
                    >
                    ...
                    <select id="vCity" name="vCity" className="form-control">
                      ...
                      {city.map(function (ct, index) {
                        if (ct.stateCode == vChangeState) {
                          return (
                            <option value={ct.stateCode}>{ct.name}</option>
                          );
                        }
                      })}
                    </select>
              ...
              >
                ...
                <select
                  onChange={(e) => setvChangeCountry1(e.target.value)}
                  id="vBillingCountry"
                  name="vBillingCountry"
                  className="col-xl-8 col-lg-7 col-md-10 col-sm-8  mb-2 "
                >
                  <option value="">Please Select Country</option>
                  {country.map(function (coun, index) {
                ...
                <select
                  id="vBillingState"
                  onChange={(e) => setvChangeState1(e.target.value)}
                  name="vBillingState"
                  className="col-xl-8 col-lg-7 col-md-10 col-sm-8  mb-2 "
                >
                  <option value="">Please Select State</option>
