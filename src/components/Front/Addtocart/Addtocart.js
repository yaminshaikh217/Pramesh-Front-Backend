...
const Addtocart = () => {
  ...
  const sizechange = (e) => {
    ...
    if (answer_array[2] == "localhost:3000") {
      var product_url =
        "http://localhost/pramesh/backend/api/product_size_wise_data_get";
    } else {
      var product_url =
        "https://pramesh.justcodenow.com/backend/api/product_size_wise_data_get";
    }
      ...
      if (Size || sizedata == "0") {
        if (Addqty != "0") {
          if (answer_array[2] == "localhost:3000") {
            ...
            var addtocart =
              "https://pramesh.justcodenow.com/backend/api/addtocart";
          }
          const dataa = axios
            .post(addtocart, fd)
            .then((res) => {
  ...
  const wishlistAdded = (e) => {
    ...
    if (iProductId != "0") {
      if (answer_array[2] == "localhost:3000") {
        ...
        var wishlist_url =
          "https://pramesh.justcodenow.com/backend/api/wishlishadded";
      }
      const dataa = axios
              ...
              <>
                ...
                <div className="col-xl-7 col-lg-7 rightcart">
                  ...
                  <input
                    type="hidden"
                    id="vQty"
                    value={Sizequntity ? Sizequntity : product.vQty}
                  />
                      ...
                      <div className="d-flex">
                        <div>
                          <input
                            ...
                            id="sizexs"
                          />
                          <label className={ErrorSize} htmlFor="sizexs">
                            XS
                          </label>
                        </div>
                        <div>
                          <input
                            ...
                            id="sizes"
                          />
                          <label className={ErrorSize} htmlFor="sizes">
                            S
                          </label>
                        </div>
                        <div>
                          <input
                            ...
                            id="sizem"
                          />
                          <label className={ErrorSize} htmlFor="sizem">
                            M
                          </label>
                        </div>
                        <div>
                          <input
                            ...
                            id="sizel"
                          />
                          <label className={ErrorSize} htmlFor="sizel">
                            L
                          </label>
                        </div>
                        <div>
                          <input
                            ...
                            id="sizexl"
                          />
                          <label className={ErrorSize} htmlFor="sizexl">
                            XL
                          </label>
                        </div>
                      </div>
              ...
              return (
                <div className="sliderImg">
                  {slider.image.map(function (img, index) {
                    return (
                      <a
                        href={`/addtocart/${btoa(slider.iProductId)}/${btoa(
                          slider.vPrice
                        )}`}
                      >
