    ...
    return (
        <>
            ...
            <section className="stories fifthPage flex-column" >
                <div className="row img secondStories  main" style={{ overflowX: "hidden" }}>
                    <div className="row">
                        ...
                        <h1 className="fourth_h1">As you wander, you may glimpse the whirring of everyday life behind the shuttered blue doors and worn indigo facades, and take in each shade of cool blue tempered with a warm toffee-tone palette. </h1>
                        ...
                        <p className="fourth_p">In the heart of Rajasthan lies a citadel of the sun: Mehrangarh Fort. Commissioned by Maharaja Man Singh (Jodhpur's last independent ruler), its impressive structure is a composite of architectural styles determined by each centuries’ ruler. The fort's heritage museum houses a fantastic collection of costumes, palanquins and paintings and magnificent restorations of four period rooms. </p>
                        ...
                        <h1 className="fourth_h1">"A palace that might have been built by titans but coloured by the morning sun." </h1>
                        ...
                        <p className="fourth_p">Tucked away to the north of the city is Jodhpur's Mandore Gardens, an ancient space that was once home to Jodhpur’s Maharajas. Abandoned for many decades, its majestic cenotaphs rise above the trees, each distinctive from the next, a medley of red sandstone against green foliage. </p>
                    ...
                    <h1 className="fourth_h1">Raas, Jodhpur’s First Luxury Boutique Hotel </h1>
                    <p className="fourth_p"> you’re looking for an oasis of luxury set in a haveli, look no further than Raas, Jodhpur’s first luxury boutique hotel. This 18th-century haveli, authentically restored in lime mortar and sandstone, is a mix of architectural styles. Rajasthani latticed facades go hand in hand with its functional elements, marrying craftsmanship with contemporary design, and of course, the most majestic views of Mehrangarh Fort swiftly at sunset.</p>
