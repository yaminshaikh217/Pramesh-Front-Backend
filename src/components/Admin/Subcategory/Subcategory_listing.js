...
class Subcategory_listing extends React.Component
{
    ...
    async componentDidMount() 
    {
        ...
        if (answer_array[2] == 'localhost:3000') {
            ...
            var url = 'https://pramesh.justcodenow.com/backend/api/all_subcategory_get';
        }
    ...
    deletedata(e)
    {
        ...
        if (answer_array[2] == 'localhost:3000') {
            ...
            var del = 'https://pramesh.justcodenow.com/backend/api/delete_subcategory';
        }
                                            ...
                                            <tbody>
                                                {
                                                    ...
                                                    (
                                                        <tr>
                                                            ...
                                                            <th>{index+1}</th>
                                                            <td><img className="h-101 w-101" src={cat.vImage} /></td>
                                                            <td>{cat.vSubTitle}</td>
                                                            <td>{cat.vTitle}</td>
                                                            ...
                                                            <td>
                                                                <Link to={`/admin/subcategory/edit/${cat.iSubcategoryId}`}>
                                                                    <a><button className="btn myBtn3">Edit</button>
                                                                    </a>&nbsp;&nbsp;&nbsp;
                                                                </Link>

                                                                <button id={`${cat.iSubcategoryId}`} className="btn myBtn2" onClick={this.deletedata}>Delete</button>
                                                            </td>
                                                        </tr>
                                                    ))
                                                }
