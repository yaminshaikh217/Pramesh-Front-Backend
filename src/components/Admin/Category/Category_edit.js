...
const Category_edit = () => {
    ...
    var iCategoryId = window.location.pathname.substring(window.location.pathname.lastIndexOf('/') + 1);
    ...
    function addcategory() 
    {
        ...
        if (answer_array[2] == 'localhost:3000') {
            ...
            var url = 'https://pramesh.justcodenow.com/backend/api/category_add';
        }
    ...
    {
        var urls = `https://pramesh.justcodenow.com/backend/api/all_category_get?iCategoryId=${iCategoryId}`;
    }
                                    ...
                                    <form>
                                        ...
                                        <div className="pl-lg-4">
                                            <div className="row">
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="form-group">
                                                        <label className="form-control-label" for="vImage">Category Image</label>
