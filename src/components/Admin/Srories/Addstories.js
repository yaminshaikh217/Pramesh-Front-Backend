                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-lg-4">
                                                    <div className="form-group">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="file" onChange={(e) => setImage(e.target.files)} name="Stories1_image" id="Stories1_image vImage" accept="image/*" className="form-control vImage" />
                                                ...
                                                <div className="col-lg-4">
                                                    <div className="form-group">
                                                        ...
                                                        <input onChange={(e) => setTitle(e.target.value)} type="text" name="Stories1_title" id="vTitle" className="form-control" placeholder="Title" />
                                                ...
                                                <div className="col-lg-4">
                                                    <div className="form-group">
                                                        ...
                                                        <textarea name="Stories1_desc" onChange={(e) => setTitle1(e.target.value)} id="vDescription" rows="4" class="form-control" placeholder="Description..."></textarea>
                                                ...
                                                <div className="col-lg-4">
                                                    <div className="form-group">
                                                        <div className="form-group">
                                                            ...
                                                            <input onChange={(e) => setImage1(e.target.files)} name="second_image1" type="file" id="vImage" accept="image/*" className="form-control vImage" />
                                                ...
                                                <div className="col-lg-4">
                                                    <div className="form-group">
                                                        <div className="form-group">
                                                            ...
                                                            <input onChange={(e) => setImage2(e.target.files)} name="second_image2" type="file" id="vImage" className="form-control vImage" />
                                                ...
                                                <div className="col-lg-4">
                                                    <div className="form-group">
                                                        <div className="form-group">
                                                            ...
                                                            <input onChange={(e) => setImage3(e.target.files)} name="second_image3" type="file" id="vImage"  accept="image/*" className="form-control vImage" />
                                                ...
                                                {/* <div className="col-lg-3">
                                                 ...
                                                 <div className="col-lg-3">
                                                    <div className="form-group">
                                                        ...
                                                        <input onChange={(e) => setTitle2(e.target.value)} name="video_link1" type="text" id="vTitle" className="form-control" placeholder="Title"  />
                                                ...
                                                <div className="col-lg-3">
                                                    <div className="form-group">
                                                        ...
                                                        <input onChange={(e) => setTitle3(e.target.value)} name="video_link2" type="text" id="vTitle" className="form-control" placeholder="Title" />
                                                ...
                                                <div className="col-lg-3">
                                                    <div className="form-group">
                                                        ...
                                                        <input onChange={(e) => setTitle4(e.target.value)} name="video_link3" type="text" id="vTitle" className="form-control" placeholder="Title" />
                                                ...
                                                <div className="col-lg-3">
                                                    <div className="form-group">
                                                        ...
                                                        <input onChange={(e) => setTitle5(e.target.value)}  name="video_link4" type="text" id="vTitle" className="form-control" placeholder="Title" />
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="form-group">
                                                        <label className="form-control-label" for="vTitle">Title</label>
                                                        <input onChange={(e) => setTitle6(e.target.value)} type="text" name="video_title" id="vTitle" className="form-control" placeholder="Title" />
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="form-group">
                                                        <label className="form-control-label" for="vDescription">Description</label>
                                                        <textarea onChange={(e) => setTitle7(e.target.value)} name="video_desc" id="vDescription" rows="4" class="form-control" placeholder="Description..."></textarea>
                                                ...
                                                <div className="col-lg-4">
                                                    <div className="form-group">
                                                        <div className="form-group">
                                                            <label className="form-control-label" for="vImage">Stories Image</label>
                                                            <input onChange={(e) => setImage4(e.target.files)}  name="second_stories_image" type="file" id="vImage"  accept="image/*" className="form-control vImage" />
                                                ...
                                                <div className="col-lg-4">
                                                    <div className="form-group">
                                                        <label className="form-control-label" for="vTitle">Title</label>
                                                        <input onChange={(e) => setTitle8(e.target.value)}  type="text" name="second_stories_title" id="vTitle" className="form-control" placeholder="Title" />
                                                ...
                                                <div className="col-lg-4">
                                                    <div className="form-group">
                                                        <label className="form-control-label" for="vDescription">Description</label>
                                                        <textarea onChange={(e) => setTitle9(e.target.value)} name="second_stories_desc" id="vDescription" rows="4" class="form-control" placeholder="Description..." ></textarea>
