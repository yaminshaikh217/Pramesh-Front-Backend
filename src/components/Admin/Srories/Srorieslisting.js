                                            ...
                                            <tbody>
                                                {
                                                    ...
                                                    (
                                                        <tr>
                                                            <th>{index+1}</th>
                                                            <td><img className="h-101 w-101" src={storie.vStories1_image} /></td>
                                                            <td>{storie.vStories1_Title}</td>
                                                            <td>{storie.dtAddedDate}</td>
                                                            <td>{storie.eStatus}</td>
                                                            <td>
                                                                <Link to={`/admin/stories/edit/${storie.iStoriesId}`}>
                                                                    <a><button className="btn myBtn3">Edit</button>
                                                                    </a>&nbsp;&nbsp;&nbsp;
                                                                </Link>
                                                                

                                                                <button id={`${storie.iStoriesId}`} class="btn myBtn2" onClick={this.deletedata}>Delete</button>
                                                            </td>
