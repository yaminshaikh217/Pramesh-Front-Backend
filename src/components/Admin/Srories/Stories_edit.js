                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-4">
                          <div className="form-group">
                            ...
                            <input
                              type="text"
                              onChange={(e) =>
                                setvStories1_Title(e.target.value)
                              }
                              value={vStories1_Title}
                              name="Stories1_title"
                              id="vTitle"
                        ...
                        <div className="col-lg-4">
                          <div className="form-group">
                            ...
                            <textarea
                              onChange={(e) =>
                                setvStories1_Desc(e.target.value)
                              }
                              value={vStories1_Desc}
                              name="Stories1_desc"
                              id="vDescription"
                              rows="4"
                              class="form-control"
                        ...
                        <div className="col-lg-3">
                          <div className="form-group">
                            ...
                            <input
                              value={vVideo_Link1}
                              onChange={(e) => setvVideo_Link1(e.target.value)}
                              name="video_link1"
                              type="text"
                              id="vTitle"
                              className="form-control"
                        ...
                        <div className="col-lg-3">
                          <div className="form-group">
                            ...
                            <input
                              value={vVideo_Link2}
                              onChange={(e) => setvVideo_Link2(e.target.value)}
                              name="video_link2"
                              type="text"
                              id="vTitle"
                              className="form-control"
                        ...
                        <div className="col-lg-3">
                          <div className="form-group">
                            ...
                            <input
                              value={vVideo_Link3}
                              onChange={(e) => setvVideo_Link3(e.target.value)}
                              name="video_link3"
                              type="text"
                              id="vTitle"
                              className="form-control"
                        ...
                        <div className="col-lg-3">
                          <div className="form-group">
                            ...
                            <input
                              value={vVideo_Link4}
                              onChange={(e) => setvVideo_Link4(e.target.value)}
                              name="video_link4"
                              type="text"
                              id="vTitle"
                              className="form-control"
                        ...
                        <div className="col-lg-6">
                          <div className="form-group">
                            ...
                            <input
                              onChange={(e) => setvVideo_Title(e.target.value)}
                              value={vVideo_Title}
                              type="text"
                              name="video_title"
                              id="vTitle"
                        ...
                        <div className="col-lg-6">
                          <div className="form-group">
                            ...
                            <textarea
                              onChange={(e) => setvVideo_Desc(e.target.value)}
                              value={vVideo_Desc}
                              name="video_desc"
                              id="vDescription"
                              rows="4"
                        ...
                        <div className="col-lg-4">
                          <div className="form-group">
                            ...
                            <input
                              onChange={(e) => setvSecond_Title(e.target.value)}
                              type="text"
                              value={vSecond_Title}
                        ...
                        <div className="col-lg-4">
                          <div className="form-group">
                            ...
                            <textarea
                              onChange={(e) => setvSecond_Desc(e.target.value)}
                              value={vSecond_Desc}
                        ...
                        <div className="col-lg-6">
                          <div className="form-group">
                            ...
                            >
                              ...
                              <option
                                selected={eStatus == "Active" ? "selected" : ""}
                                value="Active"
                              >
                                Active
                              </option>
