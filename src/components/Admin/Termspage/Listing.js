...
class Listing extends React.Component {
  ...
  deletedata(e) {
    ...
    if (answer_array[2] == "localhost:3000") {
      ...
      var del =
        "https://pramesh.justcodenow.com/backend/api/delete_terms_condition";
    }
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td
                            ...
                            dangerouslySetInnerHTML={{ __html: Terms.tAboutus }}
                          />
                          <td
                            style={{
                              "white-space": "pre-wrap",
