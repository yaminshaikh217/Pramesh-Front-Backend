...
class Newsletter_listing extends React.Component {
    ...
    async componentDidMount() {
        ...
        if (answer_array[2] == 'localhost:3000') {
            ...
            var url = 'https://pramesh.justcodenow.com/backend/api/all_news_letter_get';
        }
    ...
    deletedata(e) {
        ...
        if (answer_array[2] == 'localhost:3000') {
            ...
            var del = 'https://pramesh.justcodenow.com/backend/api/delete_news_letter';
        }
                                            ...
                                            <tbody>
                                                {
                                                    ...
                                                    (
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <Link to={`/admin/news_letter/edit/${cat.iNewsLetterId}`}>
                                                                    <a><button className="btn myBtn3">Edit</button>
                                                                    </a>&nbsp;&nbsp;&nbsp;
                                                                </Link>
                                                                <button id={`${cat.iNewsLetterId}`} class="btn myBtn2" onClick={this.deletedata}>Delete</button>
                                                            </td>
                                                        </tr>
                                                    ))
                                                }
