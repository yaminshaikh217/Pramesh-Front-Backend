                                            ...
                                            <div className="row">
                                                        ...
                                                        <select className="form-control" onChange={(e) => setCategory_v(e.target.value)}>
                                                            <option value="">Select Category</option>
                                                            {
                                                                Category.map(function (cat, index)
                                                                {
                                                                    ...
                                                                    {
                                                                        return <option value={cat.iCategoryId}>{cat.vTitle}</option>
                                                                    }
                                                                })
                                                            }
                                                        </select>
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="form-group">
                                                        ...
                                                        <input type="text" id="vTitle" onChange={(e) => setFabric(e.target.value)} className="form-control" placeholder="Title" />
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="form-group">
                                                        <button type="button" onClick={addfabric} className="btn  btn-primary">
                                                            {
                                                                Gif == true ?
