...
const Fabric_Edit = () => {
    ...
    var iFabricId = window.location.pathname.substring(window.location.pathname.lastIndexOf('/') + 1);
                        ...
                        <div className="col-xl-12 col-md-12 col-sm-12">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <form>
                                        <h6 className="heading-small text-muted mb-4">Fabric information</h6>
                                            ...
                                            <div className="row">
                                                            ...
                                                            <option value="">Select Category</option>
                                                            {
                                                                Category.map(function (cat, index)
                                                                {
                                                                    if (cat.vProductType==0)
                                                                    {
                                                                        ...
                                                                        value={cat.iCategoryId}>{cat.vTitle}</option>
                                                                    }
                                                                })
                                                            }
                                                        </select>
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="form-group">
                                                        ...
                                                        <input type="text" id="vTitle" onChange={(e) => setFabric(e.target.value)} value={Fabric} className="form-control" placeholder="Title" />
